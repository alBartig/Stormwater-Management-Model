...
//
{
    ...
    else if ( theLidProc->lidType == TREE_PIT )
    {
        SurfaceInfil =
...
//
{
    ...
    double surfaceArea      = Subcatch[j].area;
    ...
    MaxExfil += SoilPerc;
    StorageExfil = MIN(StorageExfil, MaxExfil);
    StorageExfil = MAX(StorageExfil, 0.0);
    ...
    maxDrain = maxDrain + SoilPerc - StorageExfil;
